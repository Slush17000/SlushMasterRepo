...
export class Prefab {
    ...
    static oscillatingCylinder(radius: number, height: number, longitudeCount: number, latitudeCount: number, amplitude: number = 0.1, waves: number = 4) {
        const positions: Vector3[] = [];
