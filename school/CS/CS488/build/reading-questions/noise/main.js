...
async function initialize() {
    ...
    function randomGradient3(longitude, latitude) {
        return new Vector3(Math.cos(latitude) * Math.cos(longitude), Math.sin(latitude), Math.cos(latitude) * Math.sin(longitude));
    }
