...
function generateColoredStatic(width, height) {
...
function generateStaticNoRed(width, height) {
    const n = width * height * 4;
    const pixels = new Uint8ClampedArray(n);
    for (let r = 0; r < height; ++r) {
        for (let c = 0; c < width; ++c) {
...
function generateGrayscaleStatic(width, height) {
    const n = width * height * 4;
    const pixels = new Uint8ClampedArray(n);
    for (let r = 0; r < height; ++r) {
        for (let c = 0; c < width; ++c) {
...
function generateDistanceFromCenter(width, height) {
    const n = width * height * 4;
    const pixels = new Uint8ClampedArray(n);
...
function generateXorPattern(width, height) {
    const n = width * height * 4;
    const pixels = new Uint8ClampedArray(n);
    for (let r = 0; r < height; ++r) {
        for (let c = 0; c < width; ++c) {
...
function generateSinePattern(width, height) {
    const n = width * height * 4;
    const pixels = new Uint8ClampedArray(n);
