 ...
 */
function generateSierpinski2D(level: number): Float32Array {
    ...
    function subdivide(vertices: number[], depth: number) {
        if (depth === 0) {
 ...
 */
function generateSierpinski3D(level: number): { positions: Float32Array, normals: Float32Array, vertexCount: number } {
    ...
    function subdivide(v0: Vector3, v1: Vector3, v2: Vector3, v3: Vector3, depth: number) {
        if (depth === 0) {
