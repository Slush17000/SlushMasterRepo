...
// Light position
let lightPosition: Vector3 = new Vector3(5, 5, 5);
...
async function initialize() {
  ...
  // Buttons
  const buttons = {
    red: { btn: document.getElementById('redBtn') as HTMLButtonElement, color: { r: 1.0, g: 0.0, b: 0.0 } },
    orange: { btn: document.getElementById('orangeBtn') as HTMLButtonElement, color: { r: 1.0, g: 0.5, b: 0.0 } },
    yellow: { btn: document.getElementById('yellowBtn') as HTMLButtonElement, color: { r: 1.0, g: 1.0, b: 0.0 } },
    green: { btn: document.getElementById('greenBtn') as HTMLButtonElement, color: { r: 0.0, g: 1.0, b: 0.0 } },
    blue: { btn: document.getElementById('blueBtn') as HTMLButtonElement, color: { r: 0.0, g: 0.0, b: 1.0 } },
    indigo: { btn: document.getElementById('indigoBtn') as HTMLButtonElement, color: { r: 0.29, g: 0.0, b: 0.51 } },
    violet: { btn: document.getElementById('violetBtn') as HTMLButtonElement, color: { r: 0.56, g: 0.0, b: 1.0 } },
    white: { btn: document.getElementById('whiteBtn') as HTMLButtonElement, color: { r: 1.0, g: 1.0, b: 1.0 } },
    grey: { btn: document.getElementById('greyBtn') as HTMLButtonElement, color: { r: 0.5, g: 0.5, b: 0.5 } },
    black: { btn: document.getElementById('blackBtn') as HTMLButtonElement, color: { r: 0.0, g: 0.0, b: 0.0 } }
  };
  const defaultBtn = document.getElementById('defaultBtn') as HTMLButtonElement;
  ...
  const walkBtn = document.getElementById('walkBtn') as HTMLButtonElement;
  const reachBtn = document.getElementById('reachBtn') as HTMLButtonElement;
...
function updateRotation(elapsed: number) {
  ...
  if (keys['arrowleft']) rotationY += elapsed * rotationSpeed;
  if (keys['arrowright']) rotationY -= elapsed * rotationSpeed;
  if (keys['arrowup']) rotationX += elapsed * rotationSpeed;
  if (keys['arrowdown']) rotationX -= elapsed * rotationSpeed;

  // WASD controls for position
  if (keys['a']) positionX -= elapsed * moveSpeed;
  if (keys['d']) positionX += elapsed * moveSpeed;
  if (keys['w']) positionY += elapsed * moveSpeed;
  if (keys['s']) positionY -= elapsed * moveSpeed;
